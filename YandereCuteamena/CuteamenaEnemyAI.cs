...
public class CuteamenaEnemyAI : AdvancedEnemyAI
{
    ...
    {
        Collider[] nearbyEntities = Physics.OverlapSphere(targetPlayer.transform.position, 10, LayerMask.GetMask("Enemies"), QueryTriggerInteraction.Collide);
    ...
    {
        Collider[] doors = Physics.OverlapSphere(transform.position, 10f, LayerMask.GetMask("InteractableObject"), QueryTriggerInteraction.Collide);
